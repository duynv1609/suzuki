                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <strong>{{ $voucher->price }} điểm</strong>. Hạn sử dụng của voucher này là
                                                <strong>{{ $voucher->expiry_date ? $voucher->expiry_date->format('d/m/Y') : now()->addDays($voucher->valid_duration)->format('d/m/Y') }}</strong>. Bạn xác nhận sẽ tiếp tục?
                                            </div>
