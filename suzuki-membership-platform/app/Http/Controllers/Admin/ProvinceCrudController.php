...
class ProvinceCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(Province::class);
        CRUD::setRoute(config('backpack.base.route_prefix').'/'.config('constants.adminRoutes.provinces'));
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addColumn(['name' => 'name', 'type' => 'text', 'label' => 'Tên tỉnh']);
        /**
