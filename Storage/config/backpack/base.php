...
return [
    ...
    */
    ...
    'project_name'            => 'Suzuki Membership',
    ...
    'styles'                  => [
        ...
        'css/backend.css',
        'https://cdnjs.cloudflare.com/ajax/libs/print-js/1.5.0/print.css',
    ...
    'project_logo'            => '<b>Suzuki</b> Admin',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs'             => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class'            => 'app-header navbar bg-primary navbar-color',
    ...
    'developer_name'          => 'Suzuki World',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link'          => 'https://suzuki-world.com.vn',
    ...
    'scripts'                 => [
        ...
        'js/backend.js',
        '//cdnjs.cloudflare.com/ajax/libs/autonumeric/4.1.0/autoNumeric.min.js',
        '//cdnjs.cloudflare.com/ajax/libs/print-js/1.5.0/print.js',
        ...
        'https://kit.fontawesome.com/7205ea919f.js',
