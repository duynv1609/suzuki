...
@section('header')
    <div class="container-fluid">
        ...
        @if($info ?? '')
            <x-alert :message="$info" type="info"></x-alert>
        @endif
    </div>
@endsection
